...
- `package main`: Defines the package name. The `main` package is <mark style="background: #FFB8EBA6;">a special package that indicates an executable program</mark>.
...
<mark style="background: #FFF3A3A6;">Go programs are organized into packages. A package is a collection of related Go files. </mark>The `main` package is unique as it defines the entry point for the program, but other packages can be created to organize code logically.
