...
Functional programming (FP) treats functions as fundamental operational units. <mark style="background: #FFB8EBA6;">Functions can be used as variables, passed as arguments, and returned as results</mark>. The theory behind functional programming is based on **Lambda Calculus**, which is why the coding style that supports functional programming is often referred to as **Lambda Expressions**.
