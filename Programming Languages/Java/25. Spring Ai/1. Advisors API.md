...
In addition the `getOrder()` method determines <mark style="background: #ABF7F7A6;">advisor order in the chain</mark>, while `getName()` provides a unique advisor name.
